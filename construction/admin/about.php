<?php 
$menu_active = 'about'; // ide del grupo de menu
...
/***************** PARAMETROS PARA FORM DE EDICION ***************/
	...
	$fields[] = array(
        ...
        $fields[] = array(
                        'name' => 'Abstract title (shown on home page)',
                        'field' => 'post_extra1',
                        'type' => 'text'
                        //'encrypted' => 1
                        );
        ...
        $fields[] = array(
                        'name' => 'Abstract (shown on home page)',
                        'field' => 'post_extra2',
                        'type' => 'textareamce',
                        'height' => 300
                        //'encrypted' => 1
...
/***************** PARAMETROS GENERALES ***************/	
        ...
        $extras['lista_where'] = ' WHERE post_type = "aboutPage"'; //custom where para listados
